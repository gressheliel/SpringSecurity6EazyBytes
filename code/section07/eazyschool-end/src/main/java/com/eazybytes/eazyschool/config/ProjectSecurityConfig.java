...
public class ProjectSecurityConfig {
    ...
    private final String[] securePages={"/dashboard"};
    private final String[] nonSecurePages={"/", "/home", "/holidays/**", "/contact", "/saveMsg",
    ...
    SecurityFilterChain defaultSecurityFilterChain(HttpSecurity http) throws Exception {
        ...
        http.csrf((csrf) -> csrf.disable())
                .authorizeHttpRequests((requests) -> requests.requestMatchers(securePages).authenticated()
                        .requestMatchers(nonSecurePages).permitAll())
